...
public class GridPostAdapter extends RecyclerView.Adapter<GridPostAdapter.ViewHolder> {
    ...
    public GridPostAdapter(List<Post> posts, Context context, boolean useGridView) {
        this.posts = posts;
    ...
    public GridPostAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_view_feed_item, parent, false);
